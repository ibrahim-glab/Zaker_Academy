...
namespace Zaker_Academy.Service.Services
{
    public class AuthorizationService : IAuthorizationService
    {
        ...
        public async Task<ServiceResult<string>> ConfirmResetPasswordAsync(ResetPasswordDto resetPasswordDto)
        {
            ...
            {
                result.Message = "Password Reset Failed";
                result.Error = string.Join(", ", resetResult.Errors.Select(e => e.Description));
                return result;
            }
        ...
        public async Task<ServiceResult<string>> CreateEmailTokenAsync(applicationUser applicationUser)
        {

            try
            {
                var res = new ServiceResult<string>();
                var emailToken = await userManager.GenerateEmailConfirmationTokenAsync(applicationUser);
                res.succeeded = true;
                res.Data = emailToken;
        ...
        public async Task<ServiceResult<string>> CreatePasswordTokenAsync(string Email)
        {
            ...
            return new ServiceResult<string>() { succeeded = true, Message = "Create Token Succeeded", Data = Token };
        }

        public async Task<ServiceResult<string>> CreateTokenAsync(string username)
        {
            var res = new ServiceResult<string>();
            ...
            res.succeeded = true;
            res.Data = new JwtSecurityTokenHandler().WriteToken(SecurityToken);
            return res;
        }

        public async Task<ServiceResult<string>> SendResetPasswordAsync(string UserEmail, string callBackUrl)
        {
            var result = new ServiceResult<string>();
            ...
            catch (Exception ex)
            {
                ...
                return new ServiceResult<string> { Message = "Password Reset Failed", Error = "Internal Server Error" }; // or throw an exception if needed
            }
        }

        public async Task<ServiceResult<string>> SendVerificationEmailAsync(string UserEmail, string callBackUrl)
        {
        ...
        public async Task<ServiceResult<string>> VerifyEmailAsync(string Email, string code)
        {
            ...
            {
                result.Message = "Verification Field";
                result.Error = "Your Email Is Not confirmed , Please try again later and check your email";
                return result;
            }
            result.succeeded = true;
            return result;
